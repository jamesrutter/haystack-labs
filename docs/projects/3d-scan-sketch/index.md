...
[Project exploring the workflow from 2D sketches to 3D scans using new 3D scanner tools - what it is, why it matters, what makes it interesting]
...
### Expertise Areas
- 2D sketch to 3D scan workflows
